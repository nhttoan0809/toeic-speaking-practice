...
const contactChannels = [
  {
    ...
    label: 'Ms.Smile TOEIC - Siêu Chất Siêu Nhộn',
    description: 'Cập nhật tài liệu và lịch khai giảng mới nhất.',
    icon: <FacebookIcon />,
    link: 'https://www.facebook.com/mssmiletoeic', // Placeholder
  ...
  },
  {
    id: 'tiktok',
    name: 'TikTok',
    label: 'TOEIC cùng mình hen!!!',
    description: 'Học tiếng Anh qua những video ngắn thú vị.',
    icon: <TikTokIcon />,
    link: 'https://www.tiktok.com/@ms.smiletoeic', // Placeholder
  ...
  },
  {
    ...
    label: 'Cô Luyến Ms.Smile',
    description: 'Kết nối trực tiếp để được tư vấn lộ trình học.',
    icon: <FacebookIcon />,
    link: 'https://www.facebook.com/phantmyluyen', // Placeholder
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {contactChannels.map((channel) => (
          ...
          >
            ...
            <div
              className={`absolute top-0 right-0 w-32 h-32 bg-linear-to-br ${channel.color} opacity-0 group-hover:opacity-10 transition-opacity duration-500 blur-2xl rounded-full -mr-10 -mt-10`}
            />

            <div
              className={`inline-flex items-center justify-center p-4 rounded-2xl bg-linear-to-br ${channel.color} text-white mb-6 shadow-lg group-hover:scale-110 transition-transform duration-500`}
            >
              {channel.icon}
            </div>
